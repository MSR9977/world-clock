...
export default function App() {
  ...
  return (
    <main className={isDarkMode ? "dark" : ""}>
      <div className="relative flex min-h-screen flex-col overflow-hidden bg-white px-5 py-4 text-slate-900 transition-colors dark:bg-[#121212] dark:text-white sm:py-5">
        <WorldMapBackground isDarkMode={isDarkMode} />

        <section className="relative z-10 mx-auto flex w-full max-w-[1800px] flex-1 flex-col">
        ...
        {isClearToastOpen && (
          ...
          >
            <div className="space-y-4">
              <div>
                <h2 className="text-base font-bold" id="clear-clocks-title">
                  Clear all clocks?
                </h2>
